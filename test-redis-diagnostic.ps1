...
Write-Host "[8] Prueba de Conexión Externa (localhost:6379)" -ForegroundColor Yellow
$externalPing = docker run --rm redis:7.2-alpine redis-cli -h host.docker.internal -p 6379 ping 2>&1
...
Write-Host "   • Usar puerto 6379 desde el host y Docker network" -ForegroundColor White
Write-Host ""
